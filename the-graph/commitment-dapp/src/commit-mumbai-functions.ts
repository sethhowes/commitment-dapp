...
export function handleRunChecked(event: RunCheckedEvent): void {
  let entity = new RunChecked(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.runId = event.params.runId
...
export function handleRunCreated(event: RunCreatedEvent): void {
  let entity = new RunCreated(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.runId = event.params.runId
  entity.startTime = event.params.startTime
